        ...
        <div className="lg:ml-8 xl:ml-[135px] flex flex-col items-center lg:items-start
         text-center lg:text-left justify-center flex-1 px-4 lg:px-0">
          ...
          <p className="max-w-[480px] mb-8">
            ...
            voluptates magni dolorem itaque praesentium doloribus, illo minima
            vel, inventore dolores quos, quia exercitationem repellat error quae
            saepe tempora facilis. Cupiditate.
          </p>
        </div>
